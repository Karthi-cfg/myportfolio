...
<div class="container mt-5"style="background-color:#222222!important;">
  <h4 class="text-white py-2"style="color:#fff;style;border-bottom:1px solid #007ced; width:90px;">Projects</h4>
<div class="card mt-5" style="width: 18rem;">
  <img class="card-img-top" src="/portfolio2/_templates/buildestate.png" alt="Card image cap">
  <div class="card-body">
    <p class="card-text">.</p>
  </div>
</div>
  
<a href="https://karthikeyan.selfmade.fun/buildestate/build.html"target="_blank"><button type="button" class="btn btn-secondary maincontent-btn mt-3  justify-content-center align-content-center "style="margin-left:60px;">Launch website</button></h4>
</a>
</div>
</section>
