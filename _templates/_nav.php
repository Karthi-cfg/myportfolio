 ...
 <nav class="navbar  navbar-expand-lg navigation menu1 navbar-fixed-top">
    <a href="#" class="navbar-brand text-light fs-3 "> <img src="/portfolio/karthi.jpg" id="pic" width="60" height="60" alt="my pic" style="border-radius: 50% !important; padding:10px;">Karthikeyan</a>
   
        <button class="navbar-toggler lines" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false" aria-label="Toggle navigation" style="color:white;">
